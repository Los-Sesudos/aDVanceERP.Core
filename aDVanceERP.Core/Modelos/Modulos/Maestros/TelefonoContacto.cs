...
namespace aDVanceERP.Core.Modelos.Modulos.Maestros {
    public sealed class TelefonoContacto : IEntidadBaseDatos {
        public TelefonoContacto() {
            PrefijoPais = "+0";
            NumeroTelefono = "N/A";
            Categoria = CategoriaTelefonoEnum.Movil;
            IdPersona = 0;
        }

        public TelefonoContacto(long id, string prefijoPais, string numeroTelefono, CategoriaTelefonoEnum categoria, long idPersona) {
            Id = id;
        ...
        public CategoriaTelefonoEnum Categoria { get; set; }
