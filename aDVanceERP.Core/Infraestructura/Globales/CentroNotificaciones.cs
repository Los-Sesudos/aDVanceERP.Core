...
namespace aDVanceERP.Core.Infraestructura.Globales {
    public static class CentroNotificaciones {
        ...
        public static DialogResult MostrarMensaje(string mensaje, TipoMensajeEnum tipo = TipoMensajeEnum.Info, BotonesMensajeEnum botones = BotonesMensajeEnum.ContinuarAbortar) {
