...
namespace aDVanceERP.Core.Vistas.Comun {
    public partial class VistaMensaje : Form, IVistaBase {
        ...
        public DialogResult Mostrar(string mensaje, TipoMensajeEnum tipoMensaje, BotonesMensajeEnum botones) {
            if (InvokeRequired) {
                Invoke(new Action(() => {
            ...
            btnOkYes.Text = botones switch {
                BotonesMensajeEnum.SiNo => "Si",
                BotonesMensajeEnum.AceptarCancelar => "Aceptar",
                BotonesMensajeEnum.ContinuarAbortar => "Continuar",
            };

            btnNoCancel.Text = botones switch {
                BotonesMensajeEnum.SiNo => "No",
                BotonesMensajeEnum.AceptarCancelar => "Cancelar",
                BotonesMensajeEnum.ContinuarAbortar => "Abortar",
            };
