...
namespace aDVanceERP.Core.Repositorios.Modulos.Maestros {
    public class RepoPersona : RepoEntidadBaseDatos<Persona, FiltroBusquedaPersona> {
        ...
        public Persona[] ObtenerPersonasNoMensajeros() {
            var consulta = $"""
                SELECT p.*
                FROM adv__persona p
                LEFT JOIN adv__mensajero m ON p.id_persona = m.id_persona
            ...
            return [.. ContextoBaseDatos.EjecutarConsulta(consulta, parametros, MapearEntidad).Select(e => e.entidadBase)];
        }

        public Persona[] ObtenerPersonasNoClientes() {
            var consulta = $"""
                SELECT p.*
                FROM adv__persona p
                LEFT JOIN adv__cliente c ON p.id_persona = c.id_persona
        ...
        public Persona[] ObtenerPersonasNoProveedores() {
            var consulta = $"""
                SELECT p.*
                FROM adv__persona p
        ...
        public Persona[] ObtenerPersonasNoEmpleados() {
            var consulta = $"""
                SELECT p.*
                FROM adv__persona p
                LEFT JOIN adv__empleado e ON p.id_persona = e.id_persona
        ...
        public Persona[] ObtenerPersonasEmpleados() {
            var consulta = $"""
                SELECT p.*
                FROM adv__persona p
                JOIN adv__empleado e ON p.id_persona = e.id_persona
